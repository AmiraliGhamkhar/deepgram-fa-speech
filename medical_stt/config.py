...
# Project roots (works when installed or run from source)
...
def get_settings() -> Dict[str, Any]:
    ...
    return {
        ...
        "inject_mode": cfg.get("inject_mode", "paste"),  # paste | type
        ...
        "max_reconnect_attempts": int(cfg.get("max_reconnect_attempts", 0)),  # 0 = infinite
...
def load_correction_rules() -> List[Tuple[str, str]]:
    """Return ordered (source, target) pairs for the FST."""
